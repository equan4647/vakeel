    ...
    <script>
        (function(doc) {
            ...
            var getSelectedStyles = function() {
                ...
                document.queryCommandState('justifyLeft') && styles.push('justifyLeft');
                document.queryCommandState('justifyRight') && styles.push('justifyRight');
                document.queryCommandState('justifyCenter') && styles.push('justifyCenter');
                ...
                document.queryCommandState('fontName') && styles.push('fontName');
                document.queryCommandState('fontSize') && styles.push('fontSize');
            ...
            var getRequest = function(event) {
              ...
              if(msgData.type === 'toolbar') {
                ...
                case 'setHtml':
                  ...
                  editor.setAttribute('contentEditable', msgData.editable)
                  break;
                  case 'style':
